...
project = u'Invenio-Previewer-Demobbed'
copyright = u'2017, Invenio collaboration'
...
htmlhelp_basename = 'invenio-previewer-demobbeddoc'
...
# [howto/manual]).
latex_documents = [
    ('index', 'invenio-previewer-demobbed.tex',
     u'Invenio-Previewer-Demobbed Documentation',
...
man_pages = [
    ('index', 'invenio-previewer-demobbed',
     u'Invenio-Previewer-Demobbed Documentation',
